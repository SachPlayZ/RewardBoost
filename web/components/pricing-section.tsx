  ...
  const pricingPlans = [
    {
      ...
      monthlyPrice: "$0",
      annualPrice: "$0",
      description: "Perfect for individual content creators starting out.",
      features: [
        "Generate 50 AI posts per month",
        "Basic Twitter integration",
        "Simple reward campaigns",
    ...
    },
    {
      ...
      features: [
        "Generate 500 AI posts per month",
        "Advanced content scheduling",
        "Multi-platform campaign management",
        "Smart contract lottery systems",
        "Advanced analytics and A/B testing",
        "Priority customer support",
        "Custom reward token integration",
      ],
    ...
    },
    {
      ...
      monthlyPrice: "$299",
      annualPrice: "$239",
      description: "Tailored solutions for Web3 companies and DAOs.",
      features: [
        "Unlimited AI content generation",
        "White-label campaign platform",
        "Custom smart contract deployment",
        "Dedicated account management",
        "Advanced fraud protection",
        "Multi-chain support beyond Sei",
      ...
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          ...
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-tight">
            From individual creators to enterprise Web3 companies, we have the perfect plan <br /> to power your content
        ...
        {pricingPlans.map((plan) => (
          ...
          >
            <div className="self-stretch flex flex-col justify-start items-start gap-6">
              ...
              >
                <div className="px-1.5 flex justify-center items-center gap-2">
                  <span
                    className={`text-center text-sm font-medium leading-tight ${plan.name === "Creator" ? "text-gray-800" : plan.name === "Growth" ? "text-primary" : "text-zinc-950"}`}
                  >
                    {plan.buttonText}
                  </span>
                </div>
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
              ...
              >
                {plan.name === "Creator" ? "Get Started with:" : "Everything in Creator +"}
              </div>
